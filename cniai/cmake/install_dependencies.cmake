...
if (gflags_FOUND)
    ...
    execute_process(COMMAND bash build.sh gflags WORKING_DIRECTORY ${CMAKE_CURRENT_LIST_DIR}/../3rdparty)
...
if (spdlog_FOUND)
    ...
    execute_process(COMMAND bash build.sh spdlog WORKING_DIRECTORY ${CMAKE_CURRENT_LIST_DIR}/../3rdparty)
...
if (CniaiCudaKernel_FOUND)
    ...
    execute_process(COMMAND bash build.sh WORKING_DIRECTORY ${CMAKE_CURRENT_LIST_DIR}/../cniai_cuda_kernel)
